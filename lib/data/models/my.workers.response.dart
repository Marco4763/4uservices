...
//
//     final myWorkersResponse = myWorkersResponseFromJson(jsonString);

import 'dart:convert';

MyWorkersResponse myWorkersResponseFromJson(String str) => MyWorkersResponse.fromJson(json.decode(str));

String myWorkersResponseToJson(MyWorkersResponse data) => json.encode(data.toJson());

class MyWorkersResponse {
    MyWorkersResponse({
        this.data,
    });
    ...
    factory MyWorkersResponse.fromJson(Map<String, dynamic> json) => MyWorkersResponse(
