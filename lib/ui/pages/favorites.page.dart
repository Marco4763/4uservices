...
import 'package:uservices/data/controllers/favorites.controller.dart';
...
class _FavoritesPageState extends State<FavoritesPage> {
  final _services = Get.lazyPut(() => FavoritesController());
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      Text(
                                        _.result.data[index].servico.titulo,
                                      ...
                                      Text(
                                        'A partir de R\$ ${_.result.data[index].servico.preco}',
                                        textAlign: TextAlign.right,
                                        style: TextStyle(
                                          fontFamily: "SemiBold",
                                          fontSize: 14.0,
          ...
          children: [
            ...
            Row(
              children: [
                ...
                for (int i = int.parse(
                        controller.result.data[index].servico.horario.inicio);
                    i <=
                        int.parse(
                            controller.result.data[index].servico.horario.fim);
                    i++)
                  GestureDetector(
                    onTap: () {
            ...
            Row(
              children: [
                ...
                Text('${controller.result.data[index].servico.tempo} Minutos',
                    style: TextStyle(
                      fontFamily: "SemiBold",
                      fontSize: 14.0,
                      color: Colors.white,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
                ...
                child: ListView.builder(
                  itemCount:
                      controller.result.data[index].servico.worker.length,
                  itemBuilder: (context, count) {
                    return ListTile(
                      leading: Container(
                          ...
                          height: 50,
                          child: Image.network(
                              controller.result.data[index].servico
                                  .worker[count].porfilePhoto,
                              fit: BoxFit.cover)),
                      title: Text(
                          controller
                              .result.data[index].servico.worker[count].nome,
                          style: TextStyle(
                            fontFamily: "SemiBold",
                            fontSize: 16.0,
                            color: Colors.white,
                            ...
                            if (controller.workerId.value !=
                              ...
                              setState(() {
                                controller.workerId.value = controller.result
                                    .data[index].servico.worker[count].objectId;
                              });
                            }
                          }),
                    );
              ...
              onTap: () {
                if (controller.workerId.value.isEmpty) {
                  ...
                  controller.setScchedule(
                      controller.result.data[index].servico.titulo,
                      controller.result.data[index].servico.preco);
                }
              },
              child: Container(
                  width: Get.width / 1.2,
